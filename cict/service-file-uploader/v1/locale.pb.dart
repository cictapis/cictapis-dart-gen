...
import 'error_locale.pb.dart' as $30;

class Locale extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Locale', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cict.service_file_uploader.v1'), createEmptyInstance: create)
    ...
    ..aOM<$30.ErrorLocale>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceError', subBuilder: $30.ErrorLocale.create)
  ...
  @$pb.TagNumber(2)
  $30.ErrorLocale get serviceError => $_getN(1);
  @$pb.TagNumber(2)
  set serviceError($30.ErrorLocale v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasServiceError() => $_has(1);
  @$pb.TagNumber(2)
  void clearServiceError() => clearField(2);
  @$pb.TagNumber(2)
  $30.ErrorLocale ensureServiceError() => $_ensure(1);
}

class LocaleFactory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocaleFactory', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cict.service_file_uploader.v1'), createEmptyInstance: create)
