...
//  source: cict/service-file-uploader/v1/error_locale.proto
//
// @dart = 2.12
...
class ErrorLocale extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ErrorLocale', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cict.service_file_uploader.v1'), createEmptyInstance: create)
