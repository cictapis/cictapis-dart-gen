...
class ReporterServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$2.Empty> getReporter($17.GetReporterRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ReporterServiceBase extends $grpc.Service {
  ...
  ReporterServiceBase() {
    $addMethod($grpc.ServiceMethod<$17.GetReporterRequest, $2.Empty>(
        'GetReporter',
        getReporter_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $17.GetReporterRequest.fromBuffer(value),
        ($2.Empty value) => value.writeToBuffer()));
  }

  $async.Future<$2.Empty> getReporter_Pre($grpc.ServiceCall call,
      $async.Future<$17.GetReporterRequest> request) async {
    return getReporter(call, await request);
  }

  $async.Future<$2.Empty> getReporter(
      $grpc.ServiceCall call, $17.GetReporterRequest request);
}
